...
for (const command of ['init', 'phase0', 'scan', 'health', 'doctor', 'evidence', 'context-graph', 'review-gate', 'mistake-shield', 'memory-lens', 'flight-recorder', 'export-devpost', 'demo']) {
...
assert.match(output, /--locale en\|tr/);
